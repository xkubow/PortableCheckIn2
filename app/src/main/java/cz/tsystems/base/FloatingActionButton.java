...
public class FloatingActionButton extends ImageButton {
    ...
    public FloatingActionButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, R.attr.floatingActionButtonStyle);  //R.attr.floatingActionButtonStyle);
    }
    ...
    public void initBackground() {
        ...
        if (mSize == SIZE_MINI) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                backgroundId = R.drawable.circle_mini;
            } else {
                backgroundId = R.drawable.mini;
            }
        } else {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                backgroundId = R.drawable.circle_normal;
            } else {
                backgroundId = R.drawable.normal;
            }
        }
