...
public class PrehliadkyModel extends Model {
	...
	public Cursor getPrehliadky() {		
		...
		matrixCursor.addRow(new Object[] { -1, getContext().getResources().getString(R.string.Vybavy), (long) -1,  scenar.equipment_mandat?1:0});
		matrixCursor.addRow(new Object[] { -2, getContext().getResources().getString(R.string.PovinneVybavy), (long) -1,  scenar.oblig_equipment_mandat?1:0});		
